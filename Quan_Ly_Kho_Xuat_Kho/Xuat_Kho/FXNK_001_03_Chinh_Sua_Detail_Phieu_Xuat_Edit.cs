namespace Quan_Ly_Kho_Xuat_Kho.Xuat_Kho
{
    ...
    {
        public long p_lngXuat_Kho_ID { get; set; }

        private List<CDM_San_Pham> m_arrSP = new();

        private CXNK_Xuat_Kho_Raw_Data m_objData = new();

        public FXNK_001_03_Chinh_Sua_Detail_Phieu_Xuat_Edit()
        {
            InitializeComponent();
        }
        ...
        {
            CXNK_Xuat_Kho_Raw_Data_Controller v_ctrlRaw_Data = new();
            m_objData = v_ctrlRaw_Data.FQ_734_XKRD_sp_sel_Get_By_ID(g_lngAuto_ID);
        ...
        protected override void Add_Data()
        {
            ...
            m_objData.Xuat_Kho_ID = p_lngXuat_Kho_ID;
            ...
            v_ctrlRaw_Data.FQ_734_XKRD_sp_ins_Insert(m_objData);
        }
        ...
        protected override void Update_Data()
        {
            ...
            v_ctrlRaw_Data.FQ_734_XKRD_sp_upd_Update(m_objData);
        }
