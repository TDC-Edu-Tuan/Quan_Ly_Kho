...
namespace Quan_Ly_Kho_Data_Access.Controller.Cache
{
    public class CCache_Nhom_Thanh_Vien
    {
        ...
        private static List<CSys_Nhom_Thanh_Vien> Arr_Data = new();
        private static Dictionary<string, CSys_Nhom_Thanh_Vien> Dic_Code = new();

        public static void Load_Thanh_Vien()
        {
            CSys_Nhom_Thanh_Vien_Controller v_ctrlData = new();
            List<CSys_Nhom_Thanh_Vien> v_arrTemp = v_ctrlData.FQ_525_NTV_sp_sel_List_For_Cache();
            foreach (CSys_Nhom_Thanh_Vien v_item in v_arrTemp)
                Add_Data(v_item);
        }
        ...
        public static void Add_Data(CSys_Nhom_Thanh_Vien p_objData)
        {
            ...
            //Kiểm tra trên mảng
            if (Arr_Data.FirstOrDefault(it => it.Ma_Nhom == p_objData.Ma_Nhom) != null)
                return;
            ...
            //Kiểm tra trong dic
            string v_strKey = CUtility.Tao_Key(p_objData.Ma_Nhom);
        ...
        {
            CSys_Nhom_Thanh_Vien v_objValue = Arr_Data.FirstOrDefault(it => it.Auto_ID == p_lngKho_ID);
            if (v_objValue == null)
                return;
            ...
            //Kiểm tra trong dic
            string v_strKey = CUtility.Tao_Key(v_objValue.Ma_Nhom);
        ...
        public static CSys_Nhom_Thanh_Vien Get_Data_By_ID(long p_lngAuto_ID)
        {
        ...
        public static CSys_Nhom_Thanh_Vien Get_Data_By_Code(string p_strCode)
        {
            ...
            CSys_Nhom_Thanh_Vien v_objRes = Dic_Code[v_strKey];

            return v_objRes;
        }

        public static List<CSys_Nhom_Thanh_Vien> List_Data()
        {
