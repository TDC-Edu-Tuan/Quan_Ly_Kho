...
namespace Quan_Ly_Kho_Data_Data_Access.Controller.Cache
{
    public class CCache_Loai_San_Pham
    {
        ...
        private static Dictionary<long, List<CDM_Loai_San_Pham>> Dic_Data_Chu_Hang = new Dictionary<long, List<CDM_Loai_San_Pham>>();
        ...
        public static void Add_Data(CDM_Loai_San_Pham p_objData)
        {
            ...
            string v_strKey_Code = CUtility.Tao_Key(p_objData.Chu_Hang_ID, p_objData.Ma_LSP);
            ...
            if (Dic_Data_Chu_Hang.ContainsKey(p_objData.Chu_Hang_ID) == false)
                Dic_Data_Chu_Hang.Add(p_objData.Chu_Hang_ID, new List<CDM_Loai_San_Pham>());
        ...
        public static void Delete_Data(long p_iAuto_ID)
        {
            ...
            string v_strKey_Code = CUtility.Tao_Key(v_objData.Chu_Hang_ID, v_objData.Ma_LSP);
        ...
        public static CDM_Loai_San_Pham Get_Data_By_Code(long p_iChu_Hang_ID, string p_strCode)
        {
        ...
        public static List<CDM_Loai_San_Pham> List_Data_By_Chu_Hang_ID(long p_iChu_Hang_ID)
        {
            if (Dic_Data_Chu_Hang.ContainsKey(p_iChu_Hang_ID) == true)
                return Dic_Data_Chu_Hang[p_iChu_Hang_ID].ToList();

            return new List<CDM_Loai_San_Pham>();
        }
    }
}
