...
namespace Quan_Ly_Kho_Data_Access.Controller.Danh_Muc_Co_Ban
{
    ...
    {
        public List<CDM_NCC> FQ_123_N_sp_sel_List_By_Created(long p_iChu_Hang_ID, DateTime? p_dtmFrom, DateTime? p_dtmTo)
        {
            ...
            try
            {
                ...
                v_dt = CSqlHelper.FillDataTable(CConfig.Quan_Ly_Kho_Data_Conn_String, "FQ_123_N_sp_sel_List_By_Created", p_iChu_Hang_ID, p_dtmFrom, p_dtmTo);
        ...
        public List<CDM_NCC> FQ_123_N_sp_sel_List_For_Cache()
        {
            ...
            try
            {
                v_dt = CSqlHelper.FillDataTable(CConfig.Quan_Ly_Kho_Data_Conn_String, "FQ_123_N_sp_sel_List_For_Cache");
        ...
        public CDM_NCC FQ_123_N_sp_sel_Get_By_ID(long p_iID)
        {
            ...
            try
            {
                v_dt = CSqlHelper.FillDataTable(CConfig.Quan_Ly_Kho_Data_Conn_String, "FQ_123_N_sp_sel_Get_By_ID", p_iID);
        ...
        public void FQ_123_N_sp_del_Delete_By_ID(long p_iAuto_ID, string p_strLast_Updated_By, string p_strLast_Updated_By_Function)
        {
            try
            {
                CSqlHelper.ExecuteNonquery(CConfig.Quan_Ly_Kho_Data_Conn_String, "FQ_123_N_sp_del_Delete_By_ID", p_iAuto_ID, p_strLast_Updated_By, p_strLast_Updated_By_Function);
            }
