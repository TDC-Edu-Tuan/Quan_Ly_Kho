...
namespace Quan_Ly_Kho_Data_Access.Controller.Xuat_Kho
{
    ...
    {
        public List<CXNK_Xuat_Kho> FQ_728_XK_sp_sel_List_By_Created(long p_iChu_Hang_ID, long p_iKho_ID, DateTime? p_dtmFrom, DateTime? p_dtmTo)
        {
            ...
            try
            {
                ...
                v_dt = CSqlHelper.FillDataTable(CConfig.Quan_Ly_Kho_Data_Conn_String, "FQ_728_XK_sp_sel_List_By_Created", p_iChu_Hang_ID, p_iKho_ID, p_dtmFrom, p_dtmTo);
        ...
        public List<CXNK_Xuat_Kho> FQ_728_XK_sp_sel_List_By_Created_Trang_Thai_XK_ID(long p_iChu_Hang_ID, long p_iKho_ID, int p_iTrang_Thai_XK_ID, DateTime? p_dtmFrom, DateTime? p_dtmTo)
        {
            List<CXNK_Xuat_Kho> v_arrRes = new List<CXNK_Xuat_Kho>();
            DataTable v_dt = new DataTable();
            ...
            try
            {
                ...
                v_dt = CSqlHelper.FillDataTable(CConfig.Quan_Ly_Kho_Data_Conn_String, "FQ_728_XK_sp_sel_List_By_Created_Trang_Thai_XK_ID", p_iChu_Hang_ID, p_iKho_ID, p_iTrang_Thai_XK_ID, p_dtmFrom, p_dtmTo);
        ...
        public CXNK_Xuat_Kho FQ_728_XK_sp_sel_Get_By_ID(long p_iID)
        {
            ...
            try
            {
                v_dt = CSqlHelper.FillDataTable(CConfig.Quan_Ly_Kho_Data_Conn_String, "FQ_728_XK_sp_sel_Get_By_ID", p_iID);
        ...
        public CXNK_Xuat_Kho FQ_728_XK_sp_sel_Get_By_ID(SqlConnection p_conn, SqlTransaction p_trans, long p_iID)
        {
            CXNK_Xuat_Kho v_objRes = null;
            DataTable v_dt = new DataTable();
            ...
            try
            {
                v_dt = CSqlHelper.FillDataTable(p_conn, p_trans, "FQ_728_XK_sp_sel_Get_By_ID", p_iID);
        ...
        public long FQ_728_XK_sp_ins_Insert(CXNK_Xuat_Kho p_objData)
        {
            ...
            try
            {
                v_iRes = Convert.ToInt64(CSqlHelper.ExecuteScalar(CConfig.Quan_Ly_Kho_Data_Conn_String, "FQ_728_XK_sp_ins_Insert",
        ...
        public void FQ_728_XK_sp_upd_Update(CXNK_Xuat_Kho p_objData)
        {
            try
            {
                CSqlHelper.ExecuteNonquery(CConfig.Quan_Ly_Kho_Data_Conn_String, "FQ_728_XK_sp_upd_Update", p_objData.Auto_ID,
                    p_objData.Chu_Hang_ID, p_objData.Kho_ID, p_objData.NXD_ID, p_objData.So_Phieu_Xuat, p_objData.Ngay_Xuat_Kho,
                    p_objData.Tong_SL, p_objData.Tong_Tri_Gia, p_objData.Trang_Thai_XK_ID, p_objData.Ghi_Chu, p_objData.Last_Updated_By, p_objData.Last_Updated_By_Function);
            }
        ...
        public void FQ_728_XK_sp_del_Delete_By_ID(long p_iAuto_ID, string p_strLast_Updated_By, string p_strLast_Updated_By_Function)
        {
            try
            {
                CSqlHelper.ExecuteNonquery(CConfig.Quan_Ly_Kho_Data_Conn_String, "FQ_728_XK_sp_del_Delete_By_ID", p_iAuto_ID, p_strLast_Updated_By, p_strLast_Updated_By_Function);
            }
        ...
        public void FQ_728_XK_sp_del_Delete_By_ID(SqlConnection p_conn, SqlTransaction p_trans, long p_iAuto_ID, string p_strLast_Updated_By, string p_strLast_Updated_By_Function)
        {
            try
            {
