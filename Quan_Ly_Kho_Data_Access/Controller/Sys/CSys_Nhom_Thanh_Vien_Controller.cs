    ...
    public class CSys_Nhom_Thanh_Vien_Controller
    {
        public List<CSys_Nhom_Thanh_Vien> FQ_525_NTV_sp_sel_List_By_Created(DateTime? p_dtmFrom, DateTime? p_dtmTo)
        {
            ...
            try
            {
                ...
                v_dt = CSqlHelper.FillDataTable(CConfig.Quan_Ly_Kho_Sys_Conn_String, "FQ_525_NTV_sp_sel_List_By_Created", p_dtmFrom, p_dtmTo);
        ...
        public List<CSys_Nhom_Thanh_Vien> FQ_525_NTV_sp_sel_List_For_Cache()
        {
            ...
            try
            {
                v_dt = CSqlHelper.FillDataTable(CConfig.Quan_Ly_Kho_Sys_Conn_String, "FQ_525_NTV_sp_sel_List_For_Cache");
        ...
        public CSys_Nhom_Thanh_Vien FQ_525_NTV_sp_sel_Get_By_ID(long p_iID)
        {
            ...
            try
            {
                v_dt = CSqlHelper.FillDataTable(CConfig.Quan_Ly_Kho_Sys_Conn_String, "FQ_525_NTV_sp_sel_Get_By_ID", p_iID);
        ...
        public long FQ_525_NTV_sp_ins_Insert(CSys_Nhom_Thanh_Vien p_objData)
        {
            ...
            try
            {
                v_iRes = Convert.ToInt64(CSqlHelper.ExecuteScalar(CConfig.Quan_Ly_Kho_Sys_Conn_String, "FQ_525_NTV_sp_ins_Insert",
                    p_objData.Ma_Nhom, p_objData.Ten_Nhom, p_objData.Ghi_Chu, p_objData.Last_Updated_By, p_objData.Last_Updated_By_Function));
            }
        ...
        public long FQ_525_NTV_sp_ins_Insert(SqlConnection p_conn, SqlTransaction p_trans, CSys_Nhom_Thanh_Vien p_objData)
        {
            ...
            try
            {
                v_iRes = Convert.ToInt64(CSqlHelper.ExecuteScalar(p_conn, p_trans, CConfig.Quan_Ly_Kho_Sys_Conn_String, "FQ_525_NTV_sp_ins_Insert",
                    p_objData.Ma_Nhom, p_objData.Ten_Nhom, p_objData.Ghi_Chu, p_objData.Last_Updated_By, p_objData.Last_Updated_By_Function));
            }
        ...
        public void FQ_525_NTV_sp_upd_Update(CSys_Nhom_Thanh_Vien p_objData)
        {
            try
            {
                CSqlHelper.ExecuteNonquery(CConfig.Quan_Ly_Kho_Sys_Conn_String, "FQ_525_NTV_sp_upd_Update", p_objData.Auto_ID,
                    p_objData.Ma_Nhom, p_objData.Ten_Nhom, p_objData.Ghi_Chu, p_objData.Last_Updated_By, p_objData.Last_Updated_By_Function);
            }
        ...
        public void FQ_525_NTV_sp_upd_Update(SqlConnection p_conn, SqlTransaction p_trans, CSys_Nhom_Thanh_Vien p_objData)
        {
            try
            {
                CSqlHelper.ExecuteNonquery(p_conn, p_trans, CConfig.Quan_Ly_Kho_Sys_Conn_String, "FQ_525_NTV_sp_upd_Update", p_objData.Auto_ID,
                    p_objData.Ma_Nhom, p_objData.Ten_Nhom, p_objData.Ghi_Chu, p_objData.Last_Updated_By, p_objData.Last_Updated_By_Function);
            }
        ...
        public void FQ_525_NTV_sp_del_Delete_By_ID(long p_iAuto_ID, string p_strLast_Updated_By, string p_strLast_Updated_By_Function)
        {
            try
            {
                CSqlHelper.ExecuteNonquery(CConfig.Quan_Ly_Kho_Sys_Conn_String, "FQ_525_NTV_sp_del_Delete_By_ID", p_iAuto_ID, p_strLast_Updated_By, p_strLast_Updated_By_Function);
            }
