...
{
    public class CDM_Day_Ke
    {
        private long m_lngAuto_ID;
        private long m_lngKho_ID;
        private string m_strMa_Ke;
        private string m_strTen_Ke;
        ...
        public void ResetData()
        {
            ...
            m_strMa_Ke = CConst.STR_VALUE_NULL;
            m_strTen_Ke = CConst.STR_VALUE_NULL;
        ...
        public string Ma_Ke
        {
            ...
            set
            {
                m_strMa_Ke = value.Trim();
            }
        }

        public string Ten_Ke
        {
            get
            {
                return m_strTen_Ke;
