...
{
    public partial class FXNK_001_03_Them_Detail_ASN_Edit : FBase
    {
        public List<CXNK_Nhap_Kho_Raw_Data> p_arrPara_Raw_Data { get; set; }

        private List<CDM_San_Pham> m_arrSP = new();

        private CXNK_Nhap_Kho_Raw_Data m_objData = new();

        public FXNK_001_03_Them_Detail_ASN_Edit()
        {
            InitializeComponent();
        }
