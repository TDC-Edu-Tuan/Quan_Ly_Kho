...
{
    public class FControl_Chu_Hang_User_Combo : FControl_Combobox_Base
    {
        public static void Load_Combo(ComboBox p_objCombo, List<CDM_Chu_Hang_User> p_arrData, string p_strValue_Field,
            string p_strValue_Display)
        {
            ...
            CDM_Chu_Hang_User v_objFirst = p_arrData.FirstOrDefault();
