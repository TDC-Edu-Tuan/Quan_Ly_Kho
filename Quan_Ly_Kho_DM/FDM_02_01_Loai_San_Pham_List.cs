...
namespace Quan_Ly_Kho_DM
{
    ...
    {
        private List<CDM_Loai_San_Pham> m_arrData = new();
        ...
        {
            FDM_02_03_Loai_San_Pham_Edit v_objEdit = new();
        ...
        {
            FDM_02_02_Loai_San_Pham_View v_objView = new();
        ...
        {
            CDM_Loai_San_Pham_Controller v_objCtrData = new();
            ...
            try
            {
                DataTable v_dt = v_objCtrlExcel.List_Range_Value_To_End(0, "A2", "C");
                ...
                foreach (DataRow v_row in v_dt.Rows)
                {
                    ...
                    try
                    {
                        CDM_Loai_San_Pham v_objData = new();
                        v_objData.Chu_Hang_ID = g_lngChu_Hang_ID;
                        v_objData.Ma_LSP = CUtility.Convert_To_String(v_row[0]);
                        v_objData.Ten_LSP = CUtility.Convert_To_String(v_row[1]);
                        ...
                        v_objData.Auto_ID = v_objCtrData.FQ_122_LSP_sp_ins_Insert(v_conn, v_trans, v_objData);
                        p_iCount_Success++;
                        v_trans.Commit();

                        CCache_Loai_San_Pham.Add_Data(v_objData);
        ...
        protected override void Tim_Kiem_By_Key()
        {
            ...
            List<CDM_Loai_San_Pham> v_arrData_Temp = m_arrData.ToList();
        ...
        protected override void Delete_Data(long p_lngAuto_ID)
        {
            ...
            v_objCtrlData.FQ_122_LSP_sp_del_Delete_By_ID(p_lngAuto_ID, User_Name, Function_Code);

            CCache_Loai_San_Pham.Delete_Data(p_lngAuto_ID);
        }
