...
namespace Quan_Ly_Kho_DM
{
    public partial class FDM_05_01_Vi_Tri_List : UCBase
    {
        ...
        protected override void Load_Data()
        {
            ...
            m_arrData = v_ctrlData.FQ_175_VT_sp_sel_List_By_Created(g_lngKho_ID, dtmFrom.Value, dtmTo.Value);
        ...
        {
            CDM_Vi_Tri_Controller v_objCtrData = new();
            ...
            try
            {
                ...
                foreach (DataRow v_row in v_dt.Rows)
                {
                    ...
                    try
                    {
                        CDM_Vi_Tri v_objData = new CDM_Vi_Tri();
                        v_objData.Kho_ID = g_lngKho_ID;
                        v_objData.Ma_Vi_Tri = CUtility.Convert_To_String(v_row[0]);
                        v_objData.Ten_Vi_Tri = CUtility.Convert_To_String(v_row[1]);
                        ...
                        v_objData.Auto_ID = v_objCtrData.FQ_175_VT_sp_ins_Insert(v_conn, v_trans, v_objData);
                        p_iCount_Success++;
                        v_trans.Commit();

                        CCache_Vi_Tri.Add_Data(v_objData);
                    }
                    catch (Exception ex)
                    {
        ...
        protected override void Delete_Data(long p_lngAuto_ID)
        {
            ...
            v_objCtrlData.FQ_175_VT_sp_del_Delete_By_ID(p_lngAuto_ID, User_Name, Function_Code);

            CCache_Vi_Tri.Delete_Data(p_lngAuto_ID);
        }
    }
}
