...
{
    public partial class FDM_02_03_Loai_San_Pham_Edit : FBase
    {
        private CDM_Loai_San_Pham m_objData = new();

        public FDM_02_03_Loai_San_Pham_Edit()
        {
            InitializeComponent();
        }
        ...
        protected override void Add_Data()
        {
            ...
            m_objData.Ma_LSP = txtMa_LSP.Text;
            m_objData.Ten_LSP = txtTen_LSP.Text;
            ...
            m_objData.Auto_ID = g_lngAuto_ID = v_objCtrlData.FQ_122_LSP_sp_ins_Insert(m_objData);

            CCache_Loai_San_Pham.Add_Data(m_objData);
        }
        ...
        protected override void Update_Data()
        {
            ...
            v_objCtrlData.FQ_122_LSP_sp_upd_Update(m_objData);

            CCache_Loai_San_Pham.Update_Data(m_objData);
