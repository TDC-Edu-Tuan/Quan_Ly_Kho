...
namespace Quan_Ly_Kho_DM
{
    public partial class FDM_06_01_NCC_List : UCBase
    {
        ...
        protected override void Import_Excel_Entry(CExcel_Controller v_objCtrlExcel, ref int p_iCount_Success, ref int p_iCount_Error)
        {
            ...
            try
            {
                ...
                foreach (DataRow v_row in v_dt.Rows)
                {
                    ...
                    try
                    {
                        CDM_NCC v_objData = new CDM_NCC();
                        v_objData.Chu_Hang_ID = g_lngChu_Hang_ID;
                        v_objData.Ma_NCC = CUtility.Convert_To_String(v_row[0]);
                        v_objData.Ten_NCC = CUtility.Convert_To_String(v_row[1]);
                        ...
                        v_objData.Auto_ID = v_objCtrData.FQ_123_N_sp_ins_Insert(v_conn, v_trans, v_objData);
                        p_iCount_Success++;
                        v_trans.Commit();

                        CCache_NCC.Add_Data(v_objData);
                    }
        ...
        protected override void Delete_Data(long p_lngAuto_ID)
        {
            ...
            v_objCtrlData.FQ_123_N_sp_del_Delete_By_ID(p_lngAuto_ID, User_Name, Function_Code);

            CCache_NCC.Delete_Data(p_lngAuto_ID);
        }
    }
}
