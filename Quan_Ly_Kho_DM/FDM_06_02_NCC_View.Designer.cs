...
{
    partial class FDM_06_02_NCC_View
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            txtDia_Chi_NCC = new DevExpress.XtraEditors.TextEdit();
            label9 = new Label();
            txtGhi_Chu = new DevExpress.XtraEditors.TextEdit();
            label5 = new Label();
            label4 = new Label();
            txtTen_NCC = new DevExpress.XtraEditors.TextEdit();
            txtSDT = new DevExpress.XtraEditors.TextEdit();
            label1 = new Label();
            txtMa_NCC = new DevExpress.XtraEditors.TextEdit();
            label6 = new Label();
            ...
            ((System.ComponentModel.ISupportInitialize)txtDia_Chi_NCC.Properties).BeginInit();
            ((System.ComponentModel.ISupportInitialize)txtGhi_Chu.Properties).BeginInit();
            ((System.ComponentModel.ISupportInitialize)txtTen_NCC.Properties).BeginInit();
            ((System.ComponentModel.ISupportInitialize)txtSDT.Properties).BeginInit();
            ((System.ComponentModel.ISupportInitialize)txtMa_NCC.Properties).BeginInit();
            ...
            panel1.Controls.Add(Sysem_Fields);
            ...
            // groupControl1
            // 
            groupControl1.Controls.Add(txtDia_Chi_NCC);
            ...
            groupControl1.Controls.Add(txtTen_NCC);
            groupControl1.Controls.Add(txtSDT);
            groupControl1.Controls.Add(label1);
            groupControl1.Controls.Add(txtMa_NCC);
            groupControl1.Controls.Add(label6);
            groupControl1.Location = new Point(21, 20);
            groupControl1.Margin = new Padding(3, 2, 3, 2);
            groupControl1.Name = "groupControl1";
            groupControl1.Size = new Size(598, 148);
            groupControl1.TabIndex = 19;
            groupControl1.Text = "Function Fields";
            // 
            // txtDia_Chi_NCC
            // 
            txtDia_Chi_NCC.Location = new Point(121, 109);
            txtDia_Chi_NCC.Margin = new Padding(3, 2, 3, 2);
            txtDia_Chi_NCC.Name = "txtDia_Chi_NCC";
            txtDia_Chi_NCC.Size = new Size(136, 22);
            txtDia_Chi_NCC.TabIndex = 13;
            // 
            // label9
            // 
            ...
            label5.Location = new Point(306, 73);
            label5.Name = "label5";
            ...
            // txtTen_NCC
            // 
            txtTen_NCC.Location = new Point(121, 71);
            txtTen_NCC.Margin = new Padding(3, 2, 3, 2);
            txtTen_NCC.Name = "txtTen_NCC";
            txtTen_NCC.Size = new Size(136, 22);
            txtTen_NCC.TabIndex = 9;
            // 
            // txtSDT
            // 
            ...
            // txtMa_NCC
            // 
            txtMa_NCC.Location = new Point(121, 36);
            txtMa_NCC.Margin = new Padding(3, 2, 3, 2);
            txtMa_NCC.Name = "txtMa_NCC";
            txtMa_NCC.Size = new Size(136, 22);
            txtMa_NCC.TabIndex = 1;
            txtMa_NCC.KeyPress += text_KeyPress;
            // 
            // label6
            // 
            label6.AutoSize = true;
            label6.Location = new Point(306, 41);
            label6.Name = "label6";
            ...
            Auto_ID.TabIndex = 19;
            Auto_ID.KeyPress += text_KeyPress;
            // 
            // label3
            // 
            ...
            Created.TabIndex = 3;
            Created.KeyPress += text_KeyPress;
            // 
            ...
            Last_Updated_By_Function.KeyPress += text_KeyPress;
            // 
            // Createdlb
            // 
            ...
            label2.Location = new Point(306, 148);
            label2.Name = "label2";
            ...
            Last_Updated_By.KeyPress += text_KeyPress;
            // 
            // Created_By
            // 
            ...
            Created_By.KeyPress += text_KeyPress;
            // 
            // label7
            // 
            label7.AutoSize = true;
            label7.Location = new Point(306, 118);
            label7.Name = "label7";
            ...
            Last_Updated.KeyPress += text_KeyPress;
            // 
            // label8
            // 
            label8.AutoSize = true;
            label8.Location = new Point(306, 86);
            label8.Name = "label8";
            ...
            ((System.ComponentModel.ISupportInitialize)txtDia_Chi_NCC.Properties).EndInit();
            ((System.ComponentModel.ISupportInitialize)txtGhi_Chu.Properties).EndInit();
            ((System.ComponentModel.ISupportInitialize)txtTen_NCC.Properties).EndInit();
            ((System.ComponentModel.ISupportInitialize)txtSDT.Properties).EndInit();
            ((System.ComponentModel.ISupportInitialize)txtMa_NCC.Properties).EndInit();
        ...
        private DevExpress.XtraEditors.TextEdit txtTen_NCC;
        private DevExpress.XtraEditors.TextEdit txtDia_Chi_NCC;
